...
$sql = "SELECT * FROM videos WHERE id=".$rowid;
								...
								$rw = mysqli_fetch_array($query);
											...
											echo '<form method="post" action="edit_vic.php?action=update&id='.$rowid.'" enctype="multipart/form-data" role="form" id="form">
												<div class="row">
													<div class="col-md-12">
														<h3>Edit Product</h3>
														<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['title'].'" class="form-control" id="p_name" name="title">
														</div>
														...
														<div class="form-group">
															...
															<textarea type="text"  value="" class="form-control" id="lga" name="price">'.$rw['link'].'</textarea>
														</div>
