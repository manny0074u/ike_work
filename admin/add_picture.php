...
// Include DB comnnection
require_once('inc/connect.php');

// Include add pic funtion
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<form method="post" action="add_picture.php"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
