				...
				<div class="main-content">
					...
					<div class="container">
						...
						<div class="row">
							...
							<?php
								$sql = 'SELECT * FROM agent INNER JOIN bus ON  bus.company_code=agent.company_code';
								...
								echo '
										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<td><img src="images/'.$row['c_picture'].'" alt="" width="50" height="50"></td>
														<td>'.$row['bus_type'].'</td>
						...
						echo '<td>
						<a href="bus_status.php?id='.$row['id'].'">
														...
														<a  href="change_picture.php?id='.$row['id'].'">
                                                        
															
															<i class="fa fa-upload btn btn-warning"></i>
														</a>
														</td>
...
<td>
							...
							<a class="panel-config1" href="edit_bus.php?id='.$row['id'].'" data-toggle="modal">
															
															<i class="fa fa-edit btn btn-warning"></i>
														</a></td>

														<td>
			<a href="bus_delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to DELETE this ROUTE ?\');" class="btn btn-danger">
