            ...
            if(!$_FILES['picture']['error'])
            {
                ...
                if($valid_file)
                {
                    ...
                    //$fileNameMessage = $_FILES['message']['name']; 
                     ...
                     if($_POST['name']==""  && ($_POST['price']=="" && ($_POST['details']=="" ))){
                 echo "<script>alert('Fields are empty !'); </script>";
					...
					$sql = "INSERT INTO product VALUES('','".$name."','".$price."','".$details."','".$fileName."','1','1','".$p_code."','".$upload_date."')";
					 $query = mysqli_query($con, $sql);

					 echo "<script>alert('Product successfully added!'); window.location='products.php' </script>";
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<form method="post" action="ike.php?action=add"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
											<div id="wizard" class="swMain">
													...
													<li>
														<a href="#step-1">
															...
															<span class="stepDesc"> Step 1
																<br />
																<small>Product Details </small> </span>
														</a>
													</li>
													<li>
														<a href="#step-2">
															...
															<span class="stepDesc"> Step 2
																<br />
																<small>Product Picture</small> </span>
														</a>
													</li>
												...
												<div id="step-1">
													...
													<div class="form-group">
														...
														<div class="form-group">
														<label class="col-sm-3 control-label">
															Product spec<span class="symbol required"></span>
														</label>
														<div class="col-sm-7">
												...
												<div id="step-2">
													<h2 class="StepTitle">Step 2 : Add Picture </h2>
												...
												<div class="col-sm-12">
													...
													<div class="form-group">
														...
														<div class="col-sm-2 col-sm-offset-3">
															<button name="submit" type="submit" class="btn btn-green  btn-block">
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/form_wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2016 13:54:56 GMT -->
</html>