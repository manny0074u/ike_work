...
switch ($action) {
	...
	case 'update':
     ...
     $sql = "UPDATE agent SET company_name='".$_POST['company_name']."', phone='".$_POST['phone']."' , email='".$_POST['email']."', address='".$_POST['address']."', website='".$_POST['website']."' WHERE id=".$rowid;
			$query = mysqli_query($con, $sql);

		echo "<script>alert('Update Successful!!'); window.location='agents.php' </script>";
								...
								<div class="tabbable">
									...
									<div class="tab-content">
										...
										<div id="panel_edit_account" class="tab-pane fade in active">
																...
																<?php
						$sql = "SELECT * FROM agent WHERE id=".$rowid;
								$query 	= mysqli_query($con, $sql);
								$rw = mysqli_fetch_array($query);


											echo '<form method="post" action="edit_agent.php?action=update&id='.$rowid.'" enctype="multipart/form-data" role="form" id="form">
												<div class="row">
													<div class="col-md-12">
														<h3>Edit Bus</h3>
														<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['company_name'].'" class="form-control" id="p_name" name="company_name">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['phone'].'" class="form-control" id="p_name" name="phone">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['email'].'" class="form-control" id="p_name" name="email">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['website'].'" class="form-control" id="p_name" name="Website">
														...
														<div class="form-group">
															...
															<textarea placeholder="Default Text" id="details" name="address"  class="form-control">'.$rw['address'].'</textarea>
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="fileupload-new thumbnail"><img src="images/'.$rw['c_picture'].'" alt="">
																</div>
