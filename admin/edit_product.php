...
/*if($_FILES['picture']['name'])
     ...
     $sql1 = "UPDATE product SET name='".$_POST['name']."', price='".$_POST['price']."' , details='".$_POST['details']."' WHERE id=".$rowid;
			$query = mysqli_query($con, $sql1);

		echo "<script>alert('Update Successful!!'); window.location='products.php' </script>";
...
$sql = "SELECT * FROM product WHERE id=".$rowid;
								...
								$rw = mysqli_fetch_array($query);
											...
											echo '<form method="post" action="edit_product.php?action=update&id='.$rowid.'" enctype="multipart/form-data" role="form" id="form">
												<div class="row">
													<div class="col-md-12">
														<h3>Edit Product</h3>
														<hr>
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['price'].'" class="form-control" id="lga" name="price">
														</div>
														<div class="form-group">
															<label class="control-label">
																Street
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="fileupload-new thumbnail"><img src="images/product/'.$rw['picture'].'" alt="">
																</div>
