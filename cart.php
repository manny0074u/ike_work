...
<!-- Mirrored from irsfoundation.com/tf/templates/legacy-preview/legacy/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Oct 2017 19:54:48 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Legacy || Shopping Cart</title>
    ...
    <body>
       ...
       <!--End preloader area-->
		...
		<header class="header-area">
            <div class="header-top ptb-15 bg-2">
                <div class="container">
                	<div class="row">
                		<div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="header-right">
                                <ul>
                                    <li><i class="fa fa-phone"></i> (+1) 845 1452 4154</li>
                                    <li><i class="fa fa-envelope"></i> haircut586@gmail</li>
                                </ul>
                            </div>
                        </div>
                		<div class="col-md-6 col-sm-6 col-xs-12">
...
<!-- Mirrored from irsfoundation.com/tf/templates/legacy-preview/legacy/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Oct 2017 19:54:50 GMT -->
</html>