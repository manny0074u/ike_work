 ...
 if(isset($_POST["submit"]))
{
 ...
 $sql = mysql_query("INSERT INTO location (state, city) VALUES ('$state','$city')");
 }
 ...
 if($sql){
   ...
   echo "<script>alert('Sorry there is some errors'); </script>";
 }
}
?> 
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<form name="import" method="post"  enctype="multipart/form-data" role="form" class="smart-wizard form-horizontal" id="form" >
											...
											<button class="btn btn-blue next-step btn-block" type="submit" name="submit" value="Submit">
