										...
										<thead>
												...
												while ($row = mysqli_fetch_array($query)) {
													...
													<td><img src="images/'.$row['picture'].'" alt="" width="100" height="100"></td>
														...
														<td>
			                                          <a href="inc/recipt.php?id='.$row['id'].'" target="blank_" class="btn btn-blue">
										               <i class="glyphicon glyphicon-search icon-white"></i>
														...
														echo '
			   											...
			   											<td>
			                                          <a href="inc/order_delete.php?id='.$row['id'].'" target="blank_"  onclick="return confirm(\'Are you sure you want to DELETE this Oorder ?\');" class="btn btn-danger">
