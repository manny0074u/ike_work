...
switch ($action) {
	...
	case 'update':
     ...
     $sql = "UPDATE bus SET locationfrom='".$_POST['locationfrom']."', locationto='".$_POST['locationto']."' , tod='".$_POST['tod']."', terminal_map='".$_POST['terminal_map']."', price='".$_POST['price']."', company_name='".$_POST['company_name']."', terminal_ad='".$_POST['terminal_ad']."', bus_type='".$_POST['bus_type']."', state='".$_POST['state']."', city='".$_POST['city']."', state_to='".$_POST['state_to']."', details='".$_POST['details']."' WHERE id=".$rowid;
			$query = mysqli_query($con, $sql);

		echo "<script>alert('Update Successful!!'); window.location='buses.php' </script>";
							...
							<div class="col-sm-12">
								<div class="tabbable">
									...
									<div class="tab-content">
										...
										<?php
$sql = "SELECT * FROM bus WHERE id=".$rowid;
								$query 	= mysqli_query($con, $sql);
								$rw = mysqli_fetch_array($query);


											echo '<form method="post" action="edit_bus.php?action=update&id='.$rowid.'" enctype="multipart/form-data" role="form" id="form">
												<div class="row">
													<div class="col-md-12">
														<h3>Edit Bus</h3>
														<hr>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<select class="form-control" id="lga" name="company_name">

															<option value="'.$rw['company_name'].'"> '.$row['company_name'].'</option>
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['locationfrom'].'" class="form-control" id="p_name" name="locationfrom">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['locationto'].'" class="form-control" id="p_name" name="locationto">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['state'].'" class="form-control" id="p_name" name="state">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['city'].'" class="form-control" id="p_name" name="city">
														...
														<div class="form-group">
															...
															<input type="text"  value="'.$rw['state_to'].'" class="form-control" id="p_name" name="state_to">
														...
														<div class="form-group">
															...
															<select class="form-control" id="" required name="bus_type">
																<option value="'.$rw['bus_type'].'">'.$rw['bus_type'].'</option>
														...
														<div class="form-group">
															...
															<textarea placeholder="Default Text" id="details" name="terminal_ad"  class="form-control">'.$rw['terminal_ad'].'</textarea>
														</div>
														...
														<div class="form-group">
															...
															<textarea placeholder="Default Text" id="details" name="terminal_map"  class="form-control">'.$rw['terminal_map'].'</textarea>
														</div>
														...
														<div class="form-group">
															...
															<select class="form-control" id="" required name="tod">
																<option value="'.$rw['tod'].'">'.$rw['tod'].'</option>
														...
														<div class="form-group">
															...
															<textarea class="summernote" name="details" >'.$rw['details'].'</textarea>
														</div>
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="fileupload-new thumbnail"><img src="images/'.$rw['picture'].'" alt="">
																</div>
															...
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="fileupload-new thumbnail"><img src="images/'.$row['c_picture'].'" alt="">
																</div>
																<div class="fileupload-preview fileupload-exists thumbnail"></div>
